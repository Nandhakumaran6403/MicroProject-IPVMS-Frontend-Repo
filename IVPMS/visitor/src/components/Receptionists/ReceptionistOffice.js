    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col  items-center p-6 md:p-12 lg:p-24">
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          {/* <Link to="/visitorrequestviewalltoday" className="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform">
            <div className="p-6 text-center">
              <FaCalendarDay className="text-6xl mb-3 mx-auto text-white transition-transform transform hover:rotate-12" />
              <h2 className="text-xl font-semibold mb-2">View All Visitor Requests Today</h2>
              <p className="text-sm">Review and manage all visitor requests for today.</p>
            </div>
          </Link> */}
          {/* QR Code Scanners Buttons */}
          <Link to="/qrcodescanneroffice" className="bg-green-500 hover:bg-green-600 text-white rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform">
            <div className="p-6 text-center">
              <FaQrcode className="text-6xl mb-3 mx-auto text-white transition-transform transform hover:rotate-12" />
              <h2 className="text-xl font-semibold mb-2">QR Code Scanner for Office</h2>
              <p className="text-sm">Scan the QR Code for Office Entrance.</p>
            </div>
          </Link>
        </div>
