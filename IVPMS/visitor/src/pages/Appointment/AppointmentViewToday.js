...
const AppointmentViewToday = () => {
        ...
        const fetchAppointments = async () => {
            try {
                ...
                const sortedAppointments = response.data
                    .filter(app => app.appointmentDateTime.startsWith(getCurrentDate()))
    ...
    useEffect(() => {
        const filtered = appointments.filter(app =>
            app.employee.employeeName.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {filteredAppointments.length > 0 ? filteredAppointments.map((appointment) => (
                        ...
                        <tr>
                            <td colSpan="8" className="px-6 py-4 text-center text-gray-500">No appointments found for today</td>
                        </tr>
                    )}
                </tbody>
            </table>
...
export default AppointmentViewToday;
